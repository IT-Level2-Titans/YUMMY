...
<html lang="en">
  ...
  <body>
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="RatingHome.jsp">Restaurants</a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="col-md-2">
					<a href = "Restaurant1.php"> <img src="images/hotel1.jpg" class="img-rounded" alt="First Hotel" width="304" height="220"></a>
				</div>
				<div class="col-md-2">
				</div>
				<div class="col-md-8">
					<h2>Restaurant 1</h2>
					<h5>(Here goes a brief description by one or two lines) </br> Enjoy our seated, multi-course Wine & Food Pairing by Executive Chef Bryan Jones, who creates an assortment of small dishes paired with our hand-selected Artisan Collection wines.</h5>
					<div class="rating">
