...
<button onclick="myFunction()" class="dropbtn">Search</button>
  <div id="myDropdown" class="dropdown-content">
	...
	<p><center>Download our free app to find delicious food anywhere you go...It is now available on Apple Store and Google Play.</center></p>
	</div>
	<div class="row3">
	<div class="col-md-6">
...
<form action = "RetrieveFoodAndLocationWise.php" method = "post">
<div class="row">
...
<form action = "RetrieveRestaurantWise.php" method = "post">
<div class="row">
<div class="col-sm-6 col-xs-12 text_field">
...
<form action = "RetriveLocationWise.php" method = "post">
<div class = "row">
<div class="col-sm-6 col-xs-12 text_field">
...
<div class="row7">
<div class="col-lg-12">
<p><b><center>Copyright &copy; 2016-Online Ordering - Faculty Of Information Technology</center></b></p>
</div>
</div>
</div>
