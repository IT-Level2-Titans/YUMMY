...
<label>Source</label>
<input type="txt" class="form-control" id="txtSource" value="Colombo, Western Province, Sri Lanka">
</div></div>
<div class="row">
<div class="col-sm-6 col-xs-12 text_field">
<label>Destination</label>
<input type="txt" class="form-control" id="txtDestination" value="Kandy, Central Province, Sri Lanka">
</div></div>
